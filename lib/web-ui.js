...
<script>
'use strict';
// Preset strings inspired by Chromium about://tracing presets.
var PRESETS = [
  {label: 'Web developer',
    cats: 'blink,cc,netlog,renderer,toplevel,v8'},
  {label: 'Rendering',
    cats: 'blink,cc,gpu,viz,toplevel,disabled-by-default-cc.debug'},
  {label: 'Input latency',
    cats: 'benchmark,input,evdev,renderer.scheduler,toplevel,' +
        'disabled-by-default-toplevel.flow'},
  {label: 'JS & rendering',
    cats: 'blink,cc,gpu,renderer,toplevel,v8,' +
        'disabled-by-default-v8.cpu_profiler'},
  {label: 'Memory-infra', cats: ''},
];
